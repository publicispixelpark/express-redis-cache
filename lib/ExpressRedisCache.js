module.exports = (function () {
  ...
  function ExpressRedisCache (options) {
     ...
     *  @type String
     */
    this.tls_servername = this.options.tls_servername;
     ...
     */
    if ( this.options.tls_servername ) {
      this.client = this.options.client || require('redis').createClient(this.port, this.host, { auth_pass: this.auth_pass, tls: { servername: this.options.tls_servername }});
    }
    else {
